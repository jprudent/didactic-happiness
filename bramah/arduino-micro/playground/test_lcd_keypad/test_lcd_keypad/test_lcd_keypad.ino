...
LiquidCrystal lcd(PIN_RS, PIN_ENABLE, PIN_D4, PIN_D5, PIN_D6, PIN_D7);           // select the pins used on the LCD panel
...
int read_LCD_buttons(){               // read the buttons
    adc_key_in = analogRead(PIN_BUTTONS);       // read the value from the sensor 
