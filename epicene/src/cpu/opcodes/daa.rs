...
pub fn daa() -> Box<Opcode> {
    Box::new(Daa {
        size: 1,
        cycles: 4,
        table: vec!( // stolen here https://github.com/visualboyadvance-m/visualboyadvance-m/blob/9b65a9cf29ccd626968b40f5fa9b91a9bd8bb5fb/src/gb/GB.cpp#L281
...
impl Opcode for Daa {
    fn exec(&self, cpu: &mut ComputerUnit) {
        // This instruction is really a nightmare
        // I couldn't find a way to implement it correctly
        let z = (cpu.get_af_register() & 0b0111_0000).wrapping_shl(4) | cpu.get_af_register().wrapping_shr(8);
        let af = self.table[z as usize];
