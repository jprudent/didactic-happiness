...
(def decoder
  [(->Nop)
   ...
   0x36 (->instruction [:ld <hl> word] 12 2 #(str "ld [hl]," (hex-word %)))
   0x37 (->instruction [:scf] 4 1 (constantly "scf"))
   ...
   0x3B (->instruction [:dec16 sp] 8 1 (constantly "dec sp"))
   ...
   0x3F (->instruction [:ccf] 4 1 (constantly "ccf"))
   ...
   0x76 (->instruction [:halt] 4 1 (constantly "halt"))
